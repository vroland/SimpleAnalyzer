...
\begin{DoxyCompactList}\small\item\em Extrahiert den Index einer Fläche aus einem Textblock einer Zeile der .obj-\/\-Datei. \end{DoxyCompactList}\end{DoxyCompactItemize}
