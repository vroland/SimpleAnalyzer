...
die Daten der O\-Di\-S\-I-\/\-Datei ein eine .tsd-\/\-Datei umzuwandeln. Wird duch die Funktion \hyperlink{CLGL__test_2Main_8h_a0ddf1224851353fc92bfbff6f499fa97}{main()} von außerhalb des Namespaces aufgerufen. 
\begin{DoxyParams}{Parameter}
...
\begin{center}
\leavevmode
\includegraphics[width=324pt]{classOdisiToSdConverter_a8c6bc01ae2c063d89dc64c0a7d68c033_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=338pt]{classOdisiToSdConverter_a8db961a716d43b3d4de4f2e4e19b0706_cgraph}
\end{center}
\end{figure}
