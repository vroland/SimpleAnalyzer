...
Definiert in Zeile 26 der Datei utils.\-cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=346pt]{namespaceUtils_abb647325616858e0fad55290c36ea03b_icgraph}
\end{center}
\end{figure}
...
Definiert in Zeile 68 der Datei utils.\-cpp.
...
Definiert in Zeile 35 der Datei utils.\-cpp.
...
{\em val} & Die umzuwandelnde Zahl. \\
\hline
{\em val} & Anzahl der zu übernehmenden Stellen. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Rückgabe}
Der entstandene String. 
...
Definiert in Zeile 40 der Datei utils.\-cpp.

\hypertarget{namespaceUtils_ac924242f1790eaecb91b4965d3a661aa}{\index{Utils@{Utils}!get\-Distance\-\_\-d@{get\-Distance\-\_\-d}}
\index{get\-Distance\-\_\-d@{get\-Distance\-\_\-d}!Utils@{Utils}}
\subsubsection[{get\-Distance\-\_\-d}]{\setlength{\rightskip}{0pt plus 5cm}double Utils\-::get\-Distance\-\_\-d (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{p1, }
\item[{double $\ast$}]{p2}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{namespaceUtils_ac924242f1790eaecb91b4965d3a661aa}
...
Definiert in Zeile 257 der Datei utils.\-cpp.
...
Ermöglicht das generieren aller möglichen Verteilungen von depth+1 Elementen auf data\-Point\-Count Plätze. Die Indices der Plätze, die die Elemente jeweils besetzten stehen in indices. Diese Funktion generiert aus der vorherigen Anordnung die Nächste. 
\begin{DoxyParams}{Parameter}
...
\begin{center}
\leavevmode
\includegraphics[width=196pt]{namespaceUtils_af4ba26e928c7cef5269c51bfac49d547_cgraph}
\end{center}
\end{figure}
...
Definiert in Zeile 138 der Datei utils.\-cpp.
...
Definiert in Zeile 187 der Datei utils.\-cpp.
...
Definiert in Zeile 241 der Datei utils.\-cpp.
...
Definiert in Zeile 76 der Datei utils.\-cpp.
