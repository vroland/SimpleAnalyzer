...
Lädt Objektdaten aus einer .obj-\/\-Datei. Das Objekt ist zwar schon im Speicher erstellt, wird aber erst durch diese Methode mit Daten gefüllt. \begin{DoxyReturn}{Rückgabe}
Der Fehlercode. 
\end{DoxyReturn}
...
Lädt von einfache Sensordaten (ohne Zeit) und Verknüpft diese mit dem Objekt. \begin{DoxyReturn}{Rückgabe}
Der Fehlercode. 
\end{DoxyReturn}
...
Lädt zeitgesteuerte Sensordaten und Verknüpft diese mit dem Objekt. \begin{DoxyReturn}{Rückgabe}
Der Fehlercode. 
\end{DoxyReturn}
