...
wxStaticBox(parent, wxID_ANY, wxT("Anzeigeeigenschaften")) {
	pointsCheckBox      = new wxRadioBox(parent,ID_GENERAL_VIEW_PROP,wxT("Punkte:"),wxDefaultPosition,wxDefaultSize,3,renderchoices);
	edgesCheckBox       = new wxRadioBox(parent,ID_GENERAL_VIEW_PROP,wxT("Kanten:"),wxDefaultPosition,wxDefaultSize,3,renderchoices);
	facesCheckBox       = new wxRadioBox(parent,ID_GENERAL_VIEW_PROP,wxT("Flächen:"),wxDefaultPosition,wxDefaultSize,3,renderchoices);
	matVisibilityListBox = new wxCheckListBox(parent,ID_GENERAL_VIEW_PROP);
	matVisualizationLbl    = new wxStaticText(parent,wxID_ANY,wxT("sichtbare Materialien:"));
	showExtrapolatedCheckBox    = new wxCheckBox(parent,ID_GENERAL_VIEW_PROP,wxT("zeige extrapolierte Punkte"));
	showShowSensorData    = new wxCheckBox(parent,ID_GENERAL_VIEW_PROP,wxT("zeige Sensordaten"));
	colorRangeLbl  = new wxStaticText(parent,wxID_ANY,wxT("Farbbereich (Blau-Rot) in °C:"));
	colorRangeMinEdit	  = new wxSpinCtrl(parent,ID_GENERAL_VIEW_PROP);
	colorRangeMaxEdit	  = new wxSpinCtrl(parent,ID_GENERAL_VIEW_PROP);
	viewScaleLbl = new wxStaticText(parent,ID_GENERAL_VIEW_PROP,wxT("Objektskallierung:"));
