...
Renderer::Renderer() {
	...
	viewport.cut = NULL;
	DefaultValues* defaults = wxGetApp().getDefaults();
	viewport.showPoints = defaults->viewport_showPoints;
	viewport.showEdges = defaults->viewport_showEdges;
	viewport.showFaces = defaults->viewport_showFaces;
	viewport.show_extrapolated = defaults->viewport_show_extrapolated;
	viewport.show_sensordata = defaults->viewport_show_sensordata;
	viewport.scale = defaults->viewport_scale;
